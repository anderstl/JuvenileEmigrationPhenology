...
vioplot(aa.cjs.trt.mass.cov.add5$sims.list$beta.g1[,4], 
        aa.cjs.trt.mass.cov.add5$sims.list$beta.g1[,3], 
        aa.cjs.trt.mass.cov.add5$sims.list$beta.g1[,2], 
        aa.cjs.trt.mass.cov.add5$sims.list$beta.g1[,1], 
        names=c("", "", "", ""),  
        ylim=c(-0.5, 10), col=c("plum4", "lightskyblue3", "peachpuff", "thistle1"),
        cex.lab=3, cex.axis=2.5)
mtext("Effect size", side=2, las=0, line=6, cex=2.5)
